...
| [Media](stacks/media/) | Jellyfin, Jellyseerr, Sonarr, Radarr, Prowlarr, qBittorrent | [#2](../../issues/2) |
...
| [SSO / Auth](stacks/sso/) | Authentik + Embedded Outpost + SMTP + OIDC for all apps | ✅ Done |

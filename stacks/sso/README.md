...
This document provides instructions for setting up and integrating services with Authentik for Single Sign-On (SSO).
...
1. Update `config/grafana/grafana.ini` with the following:
